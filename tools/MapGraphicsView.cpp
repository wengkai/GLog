...
void MarkerPointItem::setLabel(QGraphicsItem *label) { m_label = label; }
...
MarkerItem::MarkerItem(const QString &text, qreal size, QGraphicsItem *parent)
...
void MarkerItem::setPointOpacity(qreal opacity) { point->setOpacity(opacity); }
