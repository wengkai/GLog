...
static const SubmodeMap SUBMODE_MAP = {
    ...
    {"ASCI", {"RTTY", ""}},
    {"C4FM",
     {"DIGITALVOICE", "C4FM 4-level FSK See the Propagation_Mode enumeration section for examples "
                      "of representing C4FM voice transmissions ."}},
    {"CHIP64", {"CHIP", ""}},
    {"CHIP128", {"CHIP", ""}},
    {"DMR",
     {"DIGITALVOICE", "Digital Mobile Radio See the Propagation_Mode enumeration section for "
                      "examples of representing DMR voice transmissions ."}},
    {"DOM-M", {"DOMINO", ""}},
    {"DOM4", {"DOMINO", ""}},
    {"DOM5", {"DOMINO", ""}},
    {"DOM8", {"DOMINO", ""}},
    ...
    {"DSTAR",
     {"DIGITALVOICE",
      "Digital Smart Technologies for Amateur Radio See the Propagation_Mode enumeration section "
      "for examples of representing DSTAR voice transmissions ."}},
    {"FMHELL", {"HELL", ""}},
    ...
    {"FST4W",
     {"MFSK", "This is a digital mode supported by the WSJT-X software that is for quasi-beacon "
              "transmissions of WSPR-style messages"}},
